...
class HostProfileEditCategories extends StatelessWidget {
  const HostProfileEditCategories({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: BlocBuilder<HostProfileEditCubit, HostProfileEditState>(
            builder: (context, state) {
              return GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () {
                      context.read<HostProfileEditCubit>().toggleCategory(category);
                    },
                    child: Row(
