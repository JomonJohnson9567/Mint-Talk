...
import 'package:mint_talk/features/user_side/chat/presentation/widgets/user_chat_list_tile.dart';

class UserChatListContents extends StatelessWidget {
  const UserChatListContents({super.key});
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              children: [
                ...
                Center(
                  child: Text(
                    'Message a host from their profile to start.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 13.sp,
                      color: AppColors.subtitleText,
