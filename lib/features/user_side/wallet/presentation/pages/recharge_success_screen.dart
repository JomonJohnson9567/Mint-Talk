...
class RechargeSuccessArgs {
  final int addedPoints;
  final int totalBalance;

  const RechargeSuccessArgs({
...
class RechargeSuccessScreen extends StatelessWidget {
  final RechargeSuccessArgs args;
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Your wallet has been credited with ${args.addedPoints} points.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 16.sp,
              ...
              _BalanceInfoCard(totalBalance: args.totalBalance),
              const Spacer(flex: 3),
              PrimaryButton(
                text: 'Done',
                onPressed: () {
